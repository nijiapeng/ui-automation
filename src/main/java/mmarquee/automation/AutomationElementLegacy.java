 ...
 * </p>
 */
public class AutomationElementLegacy extends BaseAutomation {
    /**
     * <p>
     * The underlying automation element.
     * </p>
     */
    private IUIAutomationElement2 element;

    /**
     * Gets the underlying automation element.
     *
     * @return IUIAutomationElement2 The automation element.
     */
    public final IUIAutomationElement2 getElement() {
        return element;
    }
     ...
     */
    public final void setElement(final IUIAutomationElement2 inValue) {
     ...
     */
    public AutomationElementLegacy(final IUIAutomationElement2 inElement) {
...
//    }
     ...
     */
    public AutomationElementLegacy findFirst(final TreeScope scope,
        ...
        try {
            IUIAutomationElement2 elem =
                    getAutomationElementFromReferenceLegacy(pbr);
            return new AutomationElementLegacy(elem);
     ...
     * @throws AutomationException Call to Automation API failed.
     */
    public List<AutomationElementLegacy> findAllDescendants(
            final PointerByReference pCondition)
            throws AutomationException {
     ...
     * @throws AutomationException Call to Automation API failed.
     */
    public List<AutomationElementLegacy> findAll(final TreeScope scope,
                                                 final PointerByReference pCondition)
            throws AutomationException {
        List<AutomationElementLegacy> items = new ArrayList<AutomationElementLegacy>();
        ...
        for (int a = 0; a < counter; a++) {
            ...
            items.add(new AutomationElementLegacy(elem));
        }
